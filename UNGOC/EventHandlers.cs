    ...
    internal class EventHandlers
    {
        ...
        public class UNGOC_TeamRespawn 
        {
            public static void PlayerSpawn_GOCP(Player player)
            {
                ...
                player.AddAmmo(Plugin.UNGOCPlugin.Config.RespawnAmmo_Private, Plugin.UNGOCPlugin.Config.RespawnAmmos_Private);
            ...
            public static void PlayerSpawn_GOCC(Player player)
            {
                ...
                player.AddAmmo(Plugin.UNGOCPlugin.Config.RespawnAmmo_Captain, Plugin.UNGOCPlugin.Config.RespawnAmmos_Captain);
